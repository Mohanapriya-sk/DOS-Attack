...
def dos_calc():
    ...
    plot_filename2 = 'static/img/mal/null_plot.png'
    ...
    # plt.show()
    # Save the plot as a static image file
    plot_filename3 = 'static/img/mal/removenull_plot.png'
    ...
    ax.hist(data_f['legitimate'],20)

    # plt.show()
    plot_filename4 = 'static/img/mal/benignddos_plot.png'
    plt.savefig(plot_filename4)
    plt.close()
    output_directory = 'static/img/mal/features'  # Directory to save the plots
    ...
    plot_confusion_matrix(y_test, rf_pred, ['Benign', 'DDoS'], 'Random Forest Confusion Matrix','static/img/mal/random.png')
    ...
    plot_confusion_matrix(y_test, lr_pred, ['Benign', 'DDoS'], 'Logistic Regression Confusion Matrix','static/img/mal/logistic.png')
    ...
    plot_confusion_matrix(y_test, nn_pred, ['Benign', 'DDoS'], 'Neural Network Confusion Matrix','static/img/mal/neural.png')
    ...
    plt.grid()
    # plt.show()
    plot_filename8 = 'static/img/mal/modelcompare.png'
...
def plotMissingValues(dataframe):
    ...
    # plt.show()
    # Save the plot as a static image file
    plot_filename = 'static/img/mal/miss_plot.png'
    plt.savefig(plot_filename)
    plt.close()
dos_calc()
